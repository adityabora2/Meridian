...
- [x] Scaffold + venv + deps
- [x] ingest.py ((PyMuPDF parse, chunk, embed, persist FAISS) + synthetic-PDF test)
- [x] router + Mode 1/2 nodes (router, direct_answer, search, generate)
